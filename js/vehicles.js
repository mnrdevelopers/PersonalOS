                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="vehicle-log-form">
                            ...
                            <div id="fuel-fields">
                                <div id="log-wallet-container" class="mb-3 d-none">
...
window.editServiceAlert = async function(id) {
    try {
        ...
        // Always populate the alert-vehicle select fresh
        await showAddServiceAlertModal(data.vehicleId);

        // Now override with saved values (showAddServiceAlertModal resets form)
...
window.loadMaintenanceSchedule = async function() {
    // loadMaintenanceSchedule renders into vehicles-container (the main vehicles section)
    const container = document.getElementById('vehicles-container');
    if (!container) return;
